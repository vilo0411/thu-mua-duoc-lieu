# PRD: Nguyễn Việt Lộc — SEO Blog thu mua dược liệu

**Version:** 1.0
**Owner:** Nguyễn Việt Lộc
...
│
├── /ve-toi                                  ← About page (Nguyễn Việt Lộc)
└── /lien-he                                 ← Contact
```
...
| About | `Person` (Nguyễn Việt Lộc) |

Author Schema (mọi article):
```json
{
  "@type": "Person",
  "name": "Nguyễn Việt Lộc",
  "url": "https://nguyenvietloc.com/ve-toi",
  "sameAs": ["..."]
}
```
...
|---|---|---|
| `<Header>` | Mọi page | Sticky, wordmark "Nguyễn Việt Lộc" bên trái, nav ngang |
...
```
Nguyễn Việt Lộc là blog cá nhân chia sẻ kinh nghiệm về ngành dược liệu 
...
- [ ] Logo/wordmark "Nguyễn Việt Lộc" nếu có
- [ ] Bio Nguyễn Việt Lộc (cho page About)
...
- đinh lăng, ba kích, hà thủ ô, actiso, nấm linh chi
