  ...
  return (
    <div className="animate-fade-in max-w-2xl mx-auto text-center py-16 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
        <Link
          to={paths.home()}
          className="inline-flex items-center justify-center gap-2 bg-terracotta hover:bg-terracotta-dark text-white font-sans font-bold px-6 py-3 rounded-lg shadow-md transition-colors"
        >
        ...
        <Link
          to={paths.pillar()}
          className="inline-flex items-center justify-center gap-2 bg-white border border-line hover:border-terracotta text-ink-soft hover:text-terracotta font-sans font-semibold px-6 py-3 rounded-lg transition-colors"
        >
